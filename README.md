About confluence-publisher-feedstock
====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/confluence-publisher-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/Arello-Mobile/confluence-publisher

Documentation: https://github.com/Arello-Mobile/confluence-publisher
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5523&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/confluence-publisher-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `confluence-publisher` can be installed with `conda`:
...
```
mamba install confluence-publisher
```

It is possible to list all of the versions of `confluence-publisher` available on your platform with `conda`:
...
```
mamba search confluence-publisher --channel conda-forge
```
...
mamba repoquery search confluence-publisher --channel conda-forge

# List packages depending on `confluence-publisher`:
mamba repoquery whoneeds confluence-publisher --channel conda-forge

# List dependencies of `confluence-publisher`:
mamba repoquery depends confluence-publisher --channel conda-forge
```
